...
class NewGuildLinkModal extends React.Component {
  state = {
    open: false,
    linkNameInput: '',
  ...
  render() {
    ...
    return (
      <div>
        <Button className='GuildLinkModalButton' onClick={this.show('large')} color='brown'><Icon name='add circle'/>Add Link</Button>
...
export default NewGuildLinkModal;
